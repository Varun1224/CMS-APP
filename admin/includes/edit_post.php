<?php
    ...
    if(isset($_POST['update_post'])) {
        ...
        echo "<p class='bg-success' style='padding:1rem;'>Post Updated. <a class='btn btn-success' href='../post.php?p_id={$the_post_id}'>View Post </a> or <a class='btn btn-info' href='posts.php'>Edit More Posts</a></p>";
