...
<table class="table table-bordered table-hover">
        ...
        <div id="bulkOptionContainer" class="col-xs-4" style="margin-bottom:2rem;">
...
echo "<td><img width='100' src='../images/$post_image' alt='image'></td>";
        ...
        <form method="post">
         ...
         <?php   
            ...
            // echo '<td><input rel="'.$post_id.'" class="btn btn-danger delete_link" type="button" name="delete" value="Delete"></td>';
