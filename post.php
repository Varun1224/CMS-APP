<?php  include "includes/db.php"; ?>
 <?php  include "includes/header.php"; ?>
    ...
    if(!isset($stmt) && empty($stmt)){
        ?>
        <h1 class="page-header">ONLY ADMINS CAN SEE DRAFT POSTS</h1>
        <?php
    }
        ...
        <div class="well">
            ...
            <form action="#" method="post" role="form">
                ...
                <div class="form-group">
                    ...
                    <textarea name="comment_content" class="form-control" rows="3" style="resize:none;"></textarea>
                </div>
